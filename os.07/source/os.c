...
struct{uint16_t limitl, basel, basemid_attr, limith_baseh;} task0_ldt_table[256] __attribute__((aligned(8))) = {	// 8字节对齐
	[TASK_CODE_SEG / 8] = {0xffff, 0x0000, 0xfa00, 0x00cf},
	[TASK_DATA_SEG / 8] = {0xffff, 0x0000, 0xf300, 0x00cf},
};

struct{uint16_t limitl, basel, basemid_attr, limith_baseh;} task1_ldt_table[256] __attribute__((aligned(8))) = {	// 8字节对齐
	[TASK_CODE_SEG / 8] = {0xffff, 0x0000, 0xfa00, 0x00cf},
	[TASK_DATA_SEG / 8] = {0xffff, 0x0000, 0xf300, 0x00cf},
};
